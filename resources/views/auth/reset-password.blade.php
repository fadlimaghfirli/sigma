...
<head>
    ...
    <title>Atur Ulang Sandi - SIGMA</title>
            ...
            <div class="relative z-10 w-full max-w-2xl" x-data="statsCounter()" x-init="observe()">
                <div class="space-y-8">
                    ...
                    <p data-aos="fade-up" data-aos-delay="200"
                        ...
                        <span
                            x-text="lang === 'id' ? 'Amankan kembali akun SIGMA Anda dengan kata sandi baru yang kuat.' : 'Secure your SIGMA account again with a strong new password.'">
                            Amankan kembali akun SIGMA Anda dengan kata sandi baru yang kuat.
                        </span>
                    </p>
        ...
        <div
            ...
            <div class="absolute top-0 left-0 w-full p-6 sm:p-8 flex justify-between items-start z-20">
                <a href="{{ route('login') }}" data-aos="fade-down"
                    ...
                    <span class="hidden sm:inline" x-text="lang === 'id' ? 'Batal' : 'Cancel'">Batal</span>
                </a>
            ...
            <div
                ...
                <div class="mb-10 text-left">
                    ...
                    <h2 data-aos="fade-up"
                        ...
                        <span x-text="lang === 'id' ? 'Atur Ulang Sandi' : 'Reset Password'">Atur Ulang Sandi</span>
                    </h2>
                    <p data-aos="fade-up" data-aos-delay="100"
                        class="font-roboto text-zinc-500 dark:text-zinc-400 text-sm sm:text-base leading-relaxed">
                        <span
                            x-text="lang === 'id' ? 'Silakan masukkan email Anda dan buat kata sandi baru untuk akun Anda.' : 'Please enter your email and create a new password for your account.'">
                            Silakan masukkan email Anda dan buat kata sandi baru untuk akun Anda.
                        </span>
                    </p>
                </div>

                <form method="POST" action="{{ route('password.store') }}" class="space-y-5 w-full">
                    @csrf
                    ...
                    <div data-aos="fade-up" data-aos-delay="300" class="space-y-2">
                        <label for="password"
                            class="block font-space-grotesk text-sm font-bold text-zinc-700 dark:text-zinc-300"
                            x-text="lang === 'id' ? 'Kata Sandi Baru' : 'New Password'">Kata Sandi Baru</label>
                        <div class="relative" x-data="{ show: false }">
                            <input id="password" :type="show ? 'text' : 'password'" name="password" required
                                ...
                                :placeholder="lang === 'id' ? 'Buat kata sandi baru' : 'Create a new password'">
                    ...
                    <div data-aos="fade-up" data-aos-delay="400" class="space-y-2">
                        ...
                        <div class="relative" x-data="{ show: false }">
                            <input id="password_confirmation" :type="show ? 'text' : 'password'"
                                ...
                                class="w-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-white rounded-xl pl-4 pr-12 py-3.5 focus:ring-2 focus:ring-violet-500 focus:border-transparent outline-none transition-all font-roboto placeholder-zinc-400 shadow-sm"
                                :placeholder="lang === 'id' ? 'Ulangi kata sandi baru' : 'Repeat new password'">
                            <button type="button" @click="show = !show"
                                class="absolute inset-y-0 right-0 pr-4 flex items-center text-zinc-400 hover:text-violet-600 transition-colors"
                                tabindex="-1">
                                <svg x-show="!show" class="w-5 h-5" fill="none" stroke="currentColor"
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" class="pt-4">
                        <button type="submit"
                            ...
                            <span class="font-space-grotesk"
                                x-text="lang === 'id' ? 'Simpan Sandi Baru' : 'Save New Password'">Simpan Sandi
                                Baru</span>
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
