...
<body
    ...
    <main class="min-h-screen flex flex-col md:flex-row overflow-hidden">
            ...
            <div class="relative z-10 w-full max-w-2xl" x-data="statsCounter()" x-init="observe()">
                ...
                <div class="space-y-8">
                    ...
                    <h1 data-aos="fade-up" data-aos-delay="100"
                        ...
                        <span x-text="lang === 'id' ? 'Mulai Perjalanan' : 'Start Your Journey'">Mulai Perjalanan</span>
                        <br>
                        <span
                            class="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 via-fuchsia-400 to-emerald-400"
                            x-text="lang === 'id' ? 'Anda Di Sini.' : 'Right Here.'">
                            Anda Di Sini.
                        </span>
                    </h1>
                    ...
                    <p data-aos="fade-up" data-aos-delay="200"
                        ...
                        <span
                            x-text="lang === 'id' ? 'Bergabunglah dan mulai pamerkan karya inovasi terbaikmu di platform terintegrasi kami.' : 'Join us and start showcasing your best innovation projects on our integrated platform.'">Bergabunglah
                            dan mulai pamerkan karya inovasi terbaikmu di platform terintegrasi kami.</span>
                    </p>
        ...
        <div
            class="w-full md:w-1/2 lg:w-2/5 flex flex-col relative bg-white dark:bg-zinc-950 min-h-screen overflow-y-auto">
            ...
            <div
                ...
                <div class="mb-8 text-left">
                    ...
                    <h2 data-aos="fade-up"
                        ...
                        <span x-text="lang === 'id' ? 'Daftar Akun Baru' : 'Create New Account'">Daftar Akun Baru</span>
                    </h2>
                    <p data-aos="fade-up" data-aos-delay="100"
                        class="font-roboto text-zinc-500 dark:text-zinc-400 text-sm sm:text-base">
                        <span x-text="lang === 'id' ? 'Sudah memiliki akun?' : 'Already have an account?'">Sudah
                            memiliki akun?</span>
                        <a href="{{ route('login') }}"
                            class="font-semibold text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-500 hover:underline transition-all"
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5 w-full">
                    ...
                    <div data-aos="fade-up" data-aos-delay="150" class="space-y-2">
                        <label for="name"
                    ...
                    <div data-aos="fade-up" data-aos-delay="450" class="space-y-2">
                        <label for="password"
                            class="block font-space-grotesk text-sm font-bold text-zinc-700 dark:text-zinc-300"
                        ...
                        <div class="relative" x-data="{ show: false }">
                            <input id="password" :type="show ? 'text' : 'password'" name="password" required
                                ...
                                class="w-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-white rounded-xl pl-4 pr-12 py-3.5 focus:ring-2 focus:ring-violet-500 focus:border-transparent outline-none transition-all font-roboto placeholder-zinc-400 shadow-sm"
                    ...
                    <div data-aos="fade-up" data-aos-delay="550" class="space-y-2">
                        <label for="password_confirmation"
                            class="block font-space-grotesk text-sm font-bold text-zinc-700 dark:text-zinc-300"
                            x-text="lang === 'id' ? 'Konfirmasi Kata Sandi' : 'Confirm Password'">Konfirmasi Kata
                            Sandi</label>
                        <div class="relative" x-data="{ show: false }">
                    ...
                    <div data-aos="fade-up" data-aos-delay="650" class="pt-4">
                        <button type="submit"
                            ...
                            <span class="font-space-grotesk"
                                x-text="lang === 'id' ? 'Daftar Sekarang' : 'Register Now'">Daftar Sekarang</span>
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div data-aos="fade-up" data-aos-delay="750"
                    class="mt-8 text-center border-t border-zinc-200 dark:border-zinc-800 pt-6">
                    <p class="text-xs text-zinc-500 dark:text-zinc-400 font-roboto">
