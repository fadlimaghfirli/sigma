        ...
        <section class="w-full">
            ...
            <div class="flex flex-col gap-8 w-full max-w-4xl mx-auto mb-10">
                <div data-aos="fade-up"
                    ...
                    <div
                        class="w-32 h-32 shrink-0 bg-violet-100 dark:bg-violet-600 rounded-full border-4 border-zinc-50 dark:border-zinc-950 overflow-hidden shadow-inner">
                        <img src="{{ asset('developer/fadli_maghfirli.png') }}" alt="Fadli Maghfirli"
                    ...
                    <div class="flex-grow text-center sm:text-left">
                        ...
                        <div class="flex items-center justify-center sm:justify-start gap-4">
                            <a href="https://github.com/fadlimaghfirli" target="_blank"
                                class="text-zinc-400 hover:text-violet-600 transition-colors" aria-label="GitHub"><svg
                            ...
                            <a href="https://www.instagram.com/fadlimaghfirli" target="_blank"
                                class="text-zinc-400 hover:text-violet-600 transition-colors"
                ...
                <div data-aos="fade-up" data-aos-delay="100"
                    class="flex flex-col sm:flex-row items-center gap-6 sm:gap-10 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-[2rem] border border-zinc-200 dark:border-zinc-800 shadow-sm hover:shadow-lg transition-shadow">
                    <div
                        class="w-32 h-32 shrink-0 bg-emerald-100 dark:bg-emerald-600 rounded-full border-4 border-zinc-50 dark:border-zinc-950 overflow-hidden shadow-inner">
                        <img src="{{ asset('developer/m_aditya_firmansyah.png') }}" alt="M. Aditya Firmansyah"
                    ...
                    <div class="flex-grow text-center sm:text-left">
                        ...
                        <div class="flex items-center justify-center sm:justify-start gap-4">
                            <a href="https://github.com/MAdityaFirmansyah" target="_blank"
                                class="text-zinc-400 hover:text-emerald-500 transition-colors" aria-label="GitHub"><svg
                                    class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd"
                                        d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"
                                        clip-rule="evenodd" />
                                </svg></a>
                            <a href="https://www.instagram.com/iniziu_07" target="_blank"
                ...
                <div data-aos="fade-up" data-aos-delay="200"
                    class="flex flex-col sm:flex-row items-center gap-6 sm:gap-10 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-[2rem] border border-zinc-200 dark:border-zinc-800 shadow-sm hover:shadow-lg transition-shadow">
                    <div
                        class="w-32 h-32 shrink-0 bg-blue-100 dark:bg-blue-600 rounded-full border-4 border-zinc-50 dark:border-zinc-950 overflow-hidden shadow-inner">
                        <img src="{{ asset('developer/siti_masruroh.png') }}" alt="Siti Masruroh"
                            class="w-full h-full object-cover">
                    </div>
                    <div class="flex-grow text-center sm:text-left">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3 gap-2">
                        ...
                        <div class="flex items-center justify-center sm:justify-start gap-4">
                            <a href="https://github.com/imas08" target="_blank"
                                class="text-zinc-400 hover:text-blue-500 transition-colors" aria-label="GitHub"><svg
                                    class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd"
                                        d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"
                                        clip-rule="evenodd" />
                                </svg></a>
                            <a href="https://www.instagram.com/imees_xa" target="_blank"
                                class="text-zinc-400 hover:text-blue-500 transition-colors" aria-label="Instagram"><svg
