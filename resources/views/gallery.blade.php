<x-frontend-layout>
    ...
    <div x-data="{ mobileFilterOpen: false, currentCategory: '{{ request('category') ?? 'Semua' }}' }"
        ...
        <div data-aos="fade-down" data-aos-duration="800"
            ...
            <div
                class="flex-shrink-0 flex items-center gap-2.5 px-5 py-3 rounded-full bg-violet-50 dark:bg-violet-950/50 border border-violet-100 dark:border-violet-900 text-violet-600 dark:text-violet-400 shadow-sm transition-all">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10">
                    </path>
                </svg>
                <span class="font-bold font-space-grotesk text-2xl leading-none">{{ $projects->total() }}</span>
                <span class="text-sm font-medium pt-0.5" x-text="lang === 'id' ? 'Karya' : 'Projects'">Karya</span>
            </div>
        </div>
