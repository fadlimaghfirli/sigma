        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
            <div class="md:col-span-2">
                ...
                <div class="flex items-center gap-4">
                    <a href="#"
                        class="w-10 h-10 rounded-full bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:bg-violet-600 hover:text-white dark:hover:bg-violet-500 transition-all shadow-sm"><svg
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm font-roboto">
                    <li><a href="{{ url('/') }}"
                            class="text-zinc-600 dark:text-zinc-400 hover:text-violet-600 transition"
